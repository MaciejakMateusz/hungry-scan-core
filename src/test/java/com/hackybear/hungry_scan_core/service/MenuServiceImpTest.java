...
class MenuServiceImpTest {
    ...
    void findAll_returnsMappedSortedSimpleDTOs() throws LocalizedException {
        ...
        MenuSimpleDTO dto1 = new MenuSimpleDTO(2L, 100L, "A", new HashMap<>(), new ArrayList<>(), true);
        MenuSimpleDTO dto2 = new MenuSimpleDTO(1L, 100L, "B", new HashMap<>(), new ArrayList<>(), false);
    ...
    void findById_whenOwner_returnsDTO() throws LocalizedException {
        ...
        MenuSimpleDTO dto = new MenuSimpleDTO(5L, 100L, "X", new HashMap<>(), new ArrayList<>(), true);
    ...
    void save_happyPath_persistsMenuAndUpdatesUser() throws Exception {
        MenuSimpleDTO dto = new MenuSimpleDTO(null, 100L, "New", new HashMap<>(), new ArrayList<>(), false);
    ...
    void save_whenNameExists_throws() throws LocalizedException {
        MenuSimpleDTO dto = new MenuSimpleDTO(null, 100L, "Dup", new HashMap<>(), new ArrayList<>(), false);
    ...
    void update_whenNameChangedAndUnique_savesAndFlushes() throws Exception {
        MenuSimpleDTO dto = new MenuSimpleDTO(9L, 100L, "Renamed", new HashMap<>(), new ArrayList<>(), false);
        Menu menu = new Menu();
        menu.setId(9L);
        menu.setName("Old");
        menu.setRestaurant(restaurant);
    ...
    void update_whenNameCollides_throws() throws LocalizedException {
        MenuSimpleDTO dto = new MenuSimpleDTO(9L, 100L, "Rename", new HashMap<>(), new ArrayList<>(), false);
        Menu menu = new Menu();
        menu.setId(9L);
        menu.setName("Old");
        menu.setRestaurant(restaurant);
